const colors = ['#D2691E', '#FF6347', '#FF8C00', '#FFD700', '#CD853F', '#A0522D'];
...
function updateWind() {
    windTarget = Math.random() * 0.8 + 0.5;
...
class Leaf {
    ...
    update(time) {
        ...
        this.element.style.transform = `translate(${this.x + sway}px, ${this.y}px) rotateX(${this.rotationX}deg) rotateY(${this.rotationY}deg) rotateZ(${this.rotation}deg)`;
